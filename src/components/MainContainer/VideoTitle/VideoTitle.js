...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full xl:w-[75rem] 2xl:w-[100rem] absolute left-1/2 -translate-x-1/2 h-[36rem] xl:h-full z-10 px-8 xl:px-0">
      <div className="absolute top-1/2 left-10 xl:left-3 -translate-y-1/2 w-6/12 text-white">
        <h1 className="text-5xl xl:text-7xl font-medium">{title}</h1>
        <p className="text-sm my-6 xl:my-8">{overview}</p>
